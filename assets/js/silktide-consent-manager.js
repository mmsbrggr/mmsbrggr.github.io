...
class SilktideCookieBanner {
  ...
  getModalContent() {
    ...
    const onText = this.config.text?.preferences?.on || "";
    const offText = this.config.text?.preferences?.off || "";
            ...
            <fieldset>
                ...
                <div class="cookie-type-content">
                    ...
                    <label class="switch" for="cookies-${type.id}">
                        ...
                        <span class="switch__off" aria-hidden="true">${offText}</span>
                        <span class="switch__on" aria-hidden="true">${onText}</span>
                    </label>
                </div>
            </fieldset>
        `;
